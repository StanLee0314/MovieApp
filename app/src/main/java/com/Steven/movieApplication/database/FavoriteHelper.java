...
import static com.Steven.movieApplication.database.DatabaseContract.FavoriteColumns.DESCRIPTION;
import static com.Steven.movieApplication.database.DatabaseContract.FavoriteColumns.POSTER;
import static com.Steven.movieApplication.database.DatabaseContract.FavoriteColumns.RELEASE_DATE;
import static com.Steven.movieApplication.database.DatabaseContract.FavoriteColumns.TITLE;
import static com.Steven.movieApplication.database.DatabaseContract.TABLE_MOVIE;

/**
 * Created by Steven on 2/06/2018.
 * database for the favorite list.
 * use sqlite, cursor
 */
