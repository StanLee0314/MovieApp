...
/**
 *  Reference: https://gist.github.com/Plumillon/f85c6be94e2fdaf339b9
 * Created by Steven on 6/2/2018.
 *
 */


// This is a generic Recycler view adapter and view holder,
// functions as a base class for all recycler views  with click listener

public abstract class GenericAdapter<T> extends RecyclerView.Adapter<GenericAdapter.GenericViewHolder> {
    //uncertain and random list
