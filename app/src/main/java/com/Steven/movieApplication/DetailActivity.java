 ...
 * handle the movie detail and enable the favorite function
     ...
     // handle the favorite function
        ...
        btnFovorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isFavorite){
                    addFavorit();
                    Toast.makeText(DetailActivity.this, "The movie has been added", Toast.LENGTH_LONG).show();
                }else {
                    deleteFavorite();
                    Toast.makeText(DetailActivity.this, "The movie has been moved", Toast.LENGTH_LONG).show();
                }
            }
        });
